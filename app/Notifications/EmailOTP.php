...
class EmailOTP extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        ->line('Thank you for signing up with My first application ,
        To complete your registration, please verify your email address by usig the code below:')
        ->line('')
        ->line('Verification Code : '.$this->code)
        ->line('')
        ->line('If you did not sign up for an account on My first laravel project, please ignore this email.');
    }
