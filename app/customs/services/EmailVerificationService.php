...
class EmailVerificationService
{
    ...
    {
        $Code = EmailOTP::where('email', $email)->where('code', $Code)->first();
        if ($Code) {
...
//    ->header('Access-Control-Allow-Origin', '*')
    ...
    {
        $checkCodeExist = EmailOTP::where('email', $email)->first();
        if ($checkCodeExist)
    ...
    {
        Notification::send($user, new EO($this->generateVerificationCode($user->email)));
    }
}
